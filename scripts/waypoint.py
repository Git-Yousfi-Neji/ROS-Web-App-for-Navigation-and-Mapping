...
def play_sound(sound_file):
	...
	sc.playWave(path_to_sounds+sound_file)
...
def waypts(ptsnbr=2):
	...
	root = Tk()
	file_name=tkFileDialog.askopenfilename(initialdir="/home/n/catkin_ws",title="Select data points CSV",filetypes=(("files",("*.csv")),("all files","*.*")))
	root.destroy()
...
WAYPOINTS = [[pt[0],158-pt[1]] for pt in waypts()]
...
if __name__ == '__main__':
    try:
        ...
        rospy.loginfo("ROBOT reached the path end point !.")
